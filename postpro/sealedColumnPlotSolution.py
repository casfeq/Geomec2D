...
# Get run info
runInfo=np.genfromtxt(parentDirectory/"export/solveSealedColumnRunInfo.txt",dtype='str')
...
# Get dt
fileName=str(parentDirectory)+"/export/solveSealedColumn_"+solvedPairs[0]+"RunInfo.txt"
