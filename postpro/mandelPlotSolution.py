"""
	...
	presented and solved by Mandel [1].
...
for i in range(0,len(timesteps)):
	...
	if i==0:
		...
		exact,=plt.plot(pExact,xExact,'-',color='k',fillstyle='none',linewidth=1.25)
...
for i in range(0,len(timesteps)):
	...
	if i==0:
		...
		exact,=plt.plot(epsExact,xExact,'-',color='k',fillstyle='none',linewidth=1.25)
