/*
	...
	governing equations are discretized within the FVM and the resulting linear system of equations is solved with a LU Factorization found in PETSc [1]. The numerical error in comparison to the analytical solution is plotted against the meshsize to test the convergence of the method.
